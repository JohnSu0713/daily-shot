...
export default function Home(){
 ...
 return <main className="shell">
  ...
  {tab==="today"?<><section className="intro-row"><div><div className="eyebrow">{t.dailyPhoto} · {lesson.kicker.toUpperCase()}</div><h1>{lesson.concept}</h1></div><p>{t.intro}</p></section>
